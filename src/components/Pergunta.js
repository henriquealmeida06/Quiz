...
function Pergunta(){
    ...
    return(
        ...
        <div className={`bg-white w-screen flex justify-start cursor-pointer items-center ${selecionarA? "bg-green-800":''}`}><p className={`text-gray-800 pl-4 font-medium ${selecionarA?"text-white":''}`}>Abraham Lincoln</p></div>
        </div>
        ...
        <div className={`bg-white w-screen flex justify-start cursor-pointer items-center ${selecionarB? " bg-green-800":''}`}><p className={`text-gray-800 pl-4 font-medium ${selecionarB? "text-white":''}`}>Napoleão Bonaparte</p></div>
        </div>
        ...
        <div className={`bg-white w-screen flex justify-start cursor-pointer items-center ${selecionarC?"bg-green-800":''}`}><p className={`text-gray-800 pl-4 font-medium ${selecionarC?'text-white':''}`}>Pedro Álvares Cabral</p></div>
        </div>
        ...
        <div className={`bg-white w-screen flex justify-start cursor-pointer items-center ${selecionarD?'bg-green-800':''}`}><p className={`text-gray-800 pl-4 font-medium ${selecionarD? "text-white":''}`}>José Ribeiro Lima</p></div>
        </div>
